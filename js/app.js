...
async function boot() {
  ...
  const MODULES = [
    ...
    reports, forecast, analytics, analyticsRevenue, analyticsExpenses, clients, invoices, insights, settings, users
  ];
...
function buildSidebar(MODULES) {
  const navGroups = [
    ...
    { title: 'Analysis', items: ['reports', 'forecast', 'analytics', 'analytics-revenue', 'analytics-expenses'] },
