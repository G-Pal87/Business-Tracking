...
function buildView() {
  ...
  filterBar.appendChild(button('Reset Filters', { variant: 'sm ghost', onClick: () => { yearMS.reset(); monthMS.reset(); streamMS.reset(); ownerMS.reset(); propMS.reset(); clientMS.reset(); rebuildView(); } }));
