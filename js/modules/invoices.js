...
function renderLuxuryPreview(inv, client, biz) {
  ...
  return `
    <style>
      ...
      .lux-meta{display:grid;grid-template-columns:0.75fr 1fr 1fr;gap:24px;margin-bottom:36px}
      .lux-meta .lux-label{margin-bottom:12px;font:400 10px/1 "DM Sans",sans-serif;letter-spacing:.18em;text-transform:uppercase;color:#b8935a}
