  ...
  function renderHeatmap(container, entities, yr) {
    ...
    for (const [kind, kindLabel] of KINDS) {
      ...
      for (const ent of gEnts) {
        ...
        nameTd.style.cssText = 'padding:6px 12px;font-size:12px;font-weight:600;color:var(--primary,#6366f1);cursor:pointer;position:sticky;left:0;background:var(--card,#fff);white-space:nowrap;overflow:hidden;text-overflow:ellipsis;max-width:180px;border-right:1px solid var(--border)';
